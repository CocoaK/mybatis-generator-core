...
public class InsertSelectiveElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : ListUtilities.removeIdentityAndGeneratedAlwaysColumns(introspectedTable
            ...
            sb.setLength(0);
            /** 新增乐观锁 lastUpdatedDate*/
            if(introspectedColumn.getJavaProperty().equals("createdBy")){
                sb.append("currentUser");
            }else{
                sb.append(introspectedColumn.getJavaProperty());
            }

            if(introspectedColumn.getJavaProperty().equals("createdDate") || introspectedColumn.getJavaProperty().equals("lastUpdatedDate") || introspectedColumn.getJavaProperty().equals("lastUpdatedBy")){
...
//            sb.append(" != null"); //$NON-NLS-1$
            ...
            sb.setLength(0);
            if(introspectedColumn.getJavaProperty().equals("createdDate") || introspectedColumn.getJavaProperty().equals("lastUpdatedDate")){
                sb.append("now()");
            }else if(introspectedColumn.getJavaProperty().equals("createdBy")){
                sb.append("#{currentUser,jdbcType=VARCHAR}");
            }else if(introspectedColumn.getJavaProperty().equals("lastUpdatedBy")){
                sb.append("#{currentUser,jdbcType=VARCHAR}");
            }else{
                sb.append(MyBatis3FormattingUtilities
                        .getParameterClause(introspectedColumn));
