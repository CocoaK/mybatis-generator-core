...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setInsertSelectiveStatementId("insertActive"); //$NON-NLS-1$
        setSelectAllStatementId("getAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("getOne"); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeySelectiveStatementId("updateActive"); //$NON-NLS-1$
